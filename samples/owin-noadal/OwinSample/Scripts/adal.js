...
var STORAGE_STATE_RENEW_RESOURCE = STORAGE_PREFIX + ".state.renew.resource";
...
Adal.prototype.getCachedToken = function (resource) {
    ...
    var token = this._getItem(STORAGE_ACCESS_TOKEN_KEY + resource);
    var expired = this._getItem(STORAGE_EXPIRATION_KEY + resource);
...
Adal.prototype._renewToken = function (resource, callback) {
    ...
    this._saveItem(STORAGE_STATE_RENEW_RESOURCE, resource);
    this._saveItem(STORAGE_FAILED_RENEW, "");
    ...
    if (requestInfo.parameters.hasOwnProperty("error_description")) {
        ...
        if (requestInfo.stateMatch) {
            ...
            if (requestInfo.parameters.hasOwnProperty("access_token")) {
                ...
                this._saveItem(STORAGE_ACCESS_TOKEN_KEY + resource, requestInfo.parameters["access_token"]);
                this._saveItem(STORAGE_EXPIRATION_KEY + resource, this._expiresIn(requestInfo.parameters["expires_in"]));
            }
...
if (typeof angular != 'undefined') {
    ...
    AdalModule.provider('AuthenticationService', function () {
        var _adal = null;
